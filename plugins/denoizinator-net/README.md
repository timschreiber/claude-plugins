# Denoizinator for .NET

![denoizinator-net](https://raw.githubusercontent.com/timschreiber/claude-plugins/main/docs/images/denoizinator-doof.webp)
...
every matching command in every session. Ask Claude to build or test as you
normally would.
...
file in [`probes/evidence/`](https://github.com/timschreiber/claude-plugins/tree/main/probes/evidence);
see [`docs/dotnet-test-runner-findings.md`](https://github.com/timschreiber/claude-plugins/blob/main/docs/dotnet-test-runner-findings.md)
and [`docs/framework-build-findings.md`](https://github.com/timschreiber/claude-plugins/blob/main/docs/framework-build-findings.md).
...
- **`claude plugin validate` always warns about a missing `version` field.**
  ...
  [`CONTRIBUTING.md`](https://github.com/timschreiber/claude-plugins/blob/main/CONTRIBUTING.md)),
  not a bug.
